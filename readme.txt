...
Contributors: André Brum Sampaio, Lucas Tolle
...
Donate link: http://www.vivendoapalavra.org/doe-para-o-projeto
...
The Online Bible plugin installs the Holy Bible entirely in your Wordpress blog. Translates: English, Portuguese, Spanish, French and Indonesia.
...
1.5.3
	- In this new version, we made a redesign of the entire code. It is practically a new plugin.
...
= 1.5.3 =
1.5.3 This is an update to the many changes in the code. Before installing on your website, please make a general assessment. If you have questions feel free to contact the blog [the development blog](https://vivendoapalavra.org/atualizar).
